/**********************************************************\ 
 ...
 for the VisualnetPrintPlugin project
...
public:
    ...
    {
        return boost::make_shared<VisualnetPrintPlugin>();
    }
    ...
    {
        VisualnetPrintPlugin::StaticInitialize();
    }
    ...
    {
        VisualnetPrintPlugin::StaticDeinitialize();
    }
	...
	void getLoggingMethods( FB::Log::LogMethodList& outMethods )
	{
		...
		outMethods.push_back(std::make_pair(FB::Log::LogMethod_File, "c:/visualnet/vtPrintPlugin.log"));
